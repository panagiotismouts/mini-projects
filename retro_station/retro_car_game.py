...
window.set_icon(pygame.image.load('images1/car.ico')) # non copyrighted at : https://findicons.com/icon/78723/car
...
class Background:
    def __init__(self):
        self.bg = pygame.image.load('images1/road.png').convert_alpha()#To road.png dhmioyrgh8hke apo emena sth
...
class Player:
    def __init__(self):
        self.image = pygame.image.load('images1/Audi.png').convert_alpha()#https://opengameart.org/content/free-top-down-car-sprites-by-unlucky-studio   ,dwrean apo copyright, car sprites, gia mh emporikh xrhsh fysika.
        self.sound_rev = pygame.mixer.Sound('sounds1/0600.ogg') #gia ton hxo ths mhxanhs, https://bigsoundbank.com/detail-0600-acceleration-aston-martin.html
        self.sound_rev.set_volume(0.5)# for the horn :  https://www.freesoundeffects.com/free-sounds/cars-10069/
        self.sound_horn = pygame.mixer.Sound('sounds1/horn.ogg')
...
class Car:
    def __init__(self, posx):
        self.image0 = pygame.image.load('images1/Car.png').convert_alpha()
        self.image1 = pygame.image.load('images1/Mini_truck.png').convert_alpha()
        self.image2 = pygame.image.load('images1/taxi.png').convert_alpha()
...
class Flag:
    def __init__(self):
        self.image = pygame.image.load('images1/racing flag.png').convert_alpha() #https://www.transparentpng.com/download/checkered-flag-clipart-at-pic_1735.html  dwrean gia mh emporikh xrhsh.
        self.trace = (0, 0, 0, 0)
        self.posx = 210
        self.posy = -999
        self.speed = 0
...
class Game:
    def __init__(self):# ksana orizoume metavlhtes gia thn klassh game. (to antikeimeno dhladh game).
        ...
        self.gameover = False
        self.difficulty = 500
        self.FONT = pygame.font.Font('images1/Raleway-Regular.ttf', 20) #font einai h grammatoseira poy 8a xrhsimopoih8ei sto game, https://www.1001freefonts.com/raleway.font
        pygame.mixer.music.load('sounds1/Sports-Car-Idle-www.fesliyanstudios.com.ogg') #https://www.fesliyanstudios.com/royalty-free-sound-effects-download/car-driving-207
        pygame.mixer.music.set_volume(0.5)
        pygame.mixer.music.play(loops=-1)# -1 shmainei na paizei se loupa synexeia.
        self.image = pygame.image.load('images1/crashed-car-transparent-3 (1).png').convert_alpha()#http://clipart-library.com/clip-art/crashed-car-transparent-3.htm, free for commercial use
        self.sound_crash = pygame.mixer.Sound('sounds1/WoodCrashesDistant FS022705.ogg')#https://www.videvo.net/sound-effect/wood-crashes-distant-fs022705/262147/ gia ton hxo otan 8a trakarei.
        self.sound_crash.set_volume(0.5)
        self.sound_point = pygame.mixer.Sound('sounds1/mixkit-arcade-retro-changing-tab-206.ogg')# gia tous pontous. https://mixkit.co/free-sound-effects/game/
